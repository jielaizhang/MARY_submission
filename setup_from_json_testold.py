...
for k=1, n_elements(lsmaryout) do begin
...
print, ' '
    ...
    """ % (
        ...
        json_data['parameters']['run_dates'],
...
ZOOMVALUE='2'
    """ % (
        ...
        json_data['parameters']['old_template_name'],
        'YES' if 'old_template_name' not in json_data['parameters'].keys() else 'NO',
        000000 if 'old_template_name' in json_data['parameters'].keys() else
        json_data['parameters']['mary_run_template'],
        '' if 'old_template_name' in json_data['parameters'].keys() else json_data['parameters'][
